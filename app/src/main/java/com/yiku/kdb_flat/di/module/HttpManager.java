package com.yiku.kdb_flat.di.module;
...
//
//        return createRetrofit(provideRetrofitBuilder(), provideNoCashClient(provideOkHttpBuilder()), KDBApi.HOST);
//    }
    ...
    public Retrofit getPinHuoNeedCacheRetrofit() {
        ...
        if (needCashRetrofit == null) {
            synchronized (HttpManager.class) {
                needCashRetrofit = new Retrofit.Builder().baseUrl(KDBApi.HOST)
    ...
    public Retrofit getPinHuoNoCacheRetrofit() {
        ...
        if (retrofit == null) {
            synchronized (HttpManager.class) {
                retrofit = new Retrofit.Builder().baseUrl(KDBApi.HOST)
    ...
    public KDBApi getPinHuoNetCacheApi(String TAG) {
        Tag = "DEBUG-"+TAG;
        return getPinHuoNeedCacheRetrofit().create(KDBApi.class);
    }

    public KDBApi getPinHuoNoCacheApi(String TAG) {
        Tag = "DEBUG-"+TAG;
        return getPinHuoNoCacheRetrofit().create(KDBApi.class);
    }
